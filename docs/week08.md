...
1. 行政資料・インターネット検索と情報リテラシー
2. 本日の学習目標
3. 行政資料とは何か
4. 主要な行政資料（1）：省庁の白書
5. 主要な行政資料（2）：自治体の行政報告書・基本計画
6. 主要な行政資料（3）：国会会議録・政府統計
7. インターネット情報の信頼性評価（1）：ドメインで判断
8. インターネット情報の信頼性評価（2）：CRAAP テスト
9. 情報リテラシー・フェイクニュース対策
10. 図書館・データベースと無料 Web の使い分け
11. 引用・参考文献の記述方法（APA 形式の基礎）
12. 演習：行政資料を検索してみよう
13. 本日のまとめ
14. 本日の課題
...
**第09回以降「量的調査・アンケート設計」に向けて**

大谷信介ほか（2013）前掲書、第4章「調査票の設計」。
> 第09回以降で扱う質問票設計の基礎として、選択肢の作り方・順序効果・ワーディングの問題を事前に概観しておくと授業の理解が深まる。
